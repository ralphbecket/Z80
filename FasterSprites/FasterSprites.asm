...
; In: hl = xy, de = frames ptr.
Draw16x16       xor a           ; Counting 1-8 for x, A-H for y
                                ; h = 87654321, l = HGFEDCBA
                srl h
                rra
                srl h
                rra
                ld c, a         ; h = 00876543, c = 21000000
                ld a, h
                and $01
                ld b, a         ; b = 00000003
                ld a, l
                ...
                add a, 8
                or c
                ld c, a         ; c = 2100zzzz where zzzz = 8 - CBA
                ex de, hl
                add hl, bc      ; hl = frames ptr + 32100zzzz
